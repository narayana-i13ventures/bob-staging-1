...
import { selectedFuture1BMCCard, selectedFuture1CVPCard, selectedFuture2BMCCard, selectedFuture2CVPCard, selectedFuture3BMCCard, selectedFuture3CVPCard } from "@/lib/redux/slices/SelectedSlice";
      ...
      >
        ...
        >
          ...
          >
            ...
            <Stack alignItems={"flex-start"} justifyContent={"flex-start"}>
              <CommentMenu comment={comment} project={project}/>
            </Stack>
          </Stack>
